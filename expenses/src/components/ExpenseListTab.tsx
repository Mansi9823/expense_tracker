import { Box, Button, Center, HStack, Heading, Link, Spinner, Stack, Table, Tbody, Td, Th, Thead, Tr, useDisclosure } from "@chakra-ui/react"
...
export const ExpenseListTab = () => {
    ...
    const { data, isLoading, mutate } = useFrappeGetDocList<ExpenseFields>('Expense Record', {
